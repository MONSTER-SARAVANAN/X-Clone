...
const Post = ({ post }) => {
	...
	const isLiked = authUser ? likesArray.includes(authUser._id.toString()) : false;

	const isMyPost = authUser ? authUser._id.toString() === post.user._id.toString() : false;
		...
		onSuccess: (updatedLikes) => {
			...
			queryClient.setQueryData(["posts"], (oldData) => {
				return oldData.map((p) => {
					if (p._id === post._id) {
						return { ...p, likes: Array.isArray(updatedLikes) ? updatedLikes : [] };
					}
					return p;
				});
			});
